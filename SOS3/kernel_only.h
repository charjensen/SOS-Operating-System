...
typedef struct process_control_block {
	...
	struct {			
		uint32_t start_code;	// logical start address of code
		uint32_t end_code;	// logical end address of code
		uint32_t start_brk;	// logical start address of heap
		uint32_t brk;		// current end address (logical) of heap
		uint32_t start_stack;	// logical start address of stack 
		PDE *page_directory;	// physical address of page directory
	} mem;
